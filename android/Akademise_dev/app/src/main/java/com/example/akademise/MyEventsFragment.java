...
public class MyEventsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        myEventsButton.setText("Add Event");
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Filters filters = new Filters(myId);
        EventFilters searchMyEvents = new EventFilters(filters);
        Call<Event> call = akademiseApi.searchEvent(searchMyEvents,"Bearer " + myToken);
        ...
        call.enqueue(new Callback<Event>() {
            ...
            public void onResponse(Call<Event> call, Response<Event> response) {
                ...
                MyEventAdapter adapter = new MyEventAdapter(getActivity(), allEvents);
